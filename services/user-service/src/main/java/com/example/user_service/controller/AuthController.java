...
public class AuthController {
    ...
    public ResponseEntity<ResponseLoginDTO> login(@Valid @RequestBody LoginDTO loginDTO) {
        ...
        // access token
        String accessToken = this.jwtUtil.createAccessToken(authentication.getName(), responseLoginDTO.getUser());
        responseLoginDTO.setAccessToken(accessToken);
        // refresh token
        String refresh_token = this.jwtUtil.createRefreshToken(loginDTO.getUsername(), responseLoginDTO);
    ...
    public ResponseEntity<ResponseLoginDTO> getRefreshToken(@CookieValue(name = "refresh_token") String refresh_token)
        ...
        // access token
        String accessToken = this.jwtUtil.createAccessToken(email, responseLoginDTO.getUser());
        responseLoginDTO.setAccessToken(accessToken);
        // new refresh token
        String new_refresh_token = this.jwtUtil.createRefreshToken(email, responseLoginDTO);
        // save refresh token to db
